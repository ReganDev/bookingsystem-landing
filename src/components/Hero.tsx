  ...
  return (
    <section id="top" className="relative pt-28 lg:pt-32 pb-16 px-6 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
        ...
        <div className="absolute top-40 -left-40 w-[440px] h-[440px] bg-emerald-200/30 rounded-full blur-[130px]" />
      </div>
      ...
      <div className="relative max-w-7xl mx-auto grid lg:grid-cols-2 gap-y-12 gap-x-12 items-center">
        ...
        <div className="text-center lg:text-left">
          <h1 className="text-[2.4rem] sm:text-5xl lg:text-[3.6rem] font-extrabold text-slate-900 tracking-tight leading-[1.05] mb-5">
            Get fully booked,{' '}
            <span className="text-emerald-700">on autopilot</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-3.5 justify-center lg:justify-start">
            <button
              type="button"
              onClick={openEnquiry}
              className="px-7 py-3.5 rounded-xl bg-emerald-700 hover:bg-emerald-600 text-white font-semibold text-base transition-colors cursor-pointer"
            >
              Get started
            </button>
            <a
        ...
        <div className="relative">
          ...
          <div className="absolute left-1/2 -translate-x-1/2 bottom-0 sm:bottom-1 lg:left-0 lg:translate-x-0 lg:bottom-6">
            <div className="flex items-center gap-2.5 rounded-full border border-slate-300 bg-white px-3.5 py-2">
          ...
          <div className="absolute right-1 top-2 lg:top-4 hidden sm:block">
            <div className="flex items-center gap-2 rounded-full border border-emerald-300 bg-white px-3 py-1.5">
      ...
      <div className="relative max-w-5xl mx-auto mt-20 lg:mt-24">
        ...
        <div className="relative rounded-2xl border border-slate-300 bg-white overflow-hidden">
